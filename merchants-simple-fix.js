// Simple Merchants Fix - Direct table rendering without complex initialization
console.log('Loading simple merchants fix...');
...
function renderMerchantsTableSimple() {
    console.log('Simple render function called');
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Simple fix DOM loaded');
    renderMerchantsTableSimple();
});
...
console.log('Simple merchants fix loaded');
