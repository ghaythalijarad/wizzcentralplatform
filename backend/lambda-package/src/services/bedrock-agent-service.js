...
function buildWhizzMePrompt(context) {
  ...
  let prompt = `You are WhizzMe, an AI support assistant for WhizzMerchants - a merchant platform for restaurants and businesses. You help merchants with their questions and issues.
